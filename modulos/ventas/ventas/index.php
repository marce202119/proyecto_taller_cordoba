                            ...
                            <div class="row clearfix">
                                <div class="col-md-2">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="ventas_nro" value="<?php echo "001" ?>" class="form-control" disabled>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="datetime" id="vent_fech_emision" value="<?= date('d/m/Y h:m:s') ?>" class="form-control datetimepicker" disabled>
                                ...
                                <div class="col-md-5">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <input type="text" id="cliente" class="form-control editables" onkeyup="getClientes()" disabled>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="hidden" id="pedido_nro" value="0">
                                            <input type="text" id="pedidos" class="form-control editables" onclick="getPedidos()" disabled>
                                            <label class="form-label">Pedido Nº</label>
                                            <div id="listaPedidos" style="display: none;">
                                                <ul class="list-group" id="ulPedidos"></ul>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="hidden" id="tip_fac_nro" value="0">
                                            <input type="text" id="condicion" class="form-control editables"  onclick="getCondi()" disabled>
                                            <label class="form-label">Condición</label>
                                            <div id="listaCondi" style="display: none;">
                                                <ul class="list-group" id="ulCondi"></ul>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" id="vent_cuotas" value="0" class="form-control editable" disabled>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" id="vent_plazo" value="0" class="form-control editable" disabled>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="vent_estado" class="form-control" disabled>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="vent_fech_cancel_f" class="form-control" disabled>
                                            <label class="form-label">Fecha Anulado</label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                <div class="col-md-5">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="hidden" id="depo_nro" value="0">
                                            <input type="hidden" id="items_nro" value="0">
                                            <input type="text" id="mercaderia" class="form-control editableDet" onclick="getProducto()">
